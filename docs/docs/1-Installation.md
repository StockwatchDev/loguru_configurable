...
[poetry](https://python-poetry.org) or [uv](https://docs.astral.sh/uv/). The package is not available on
...
=== "Windows"
    ...
    uv add git+https://github.com/StockwatchDev/loguru_configurable#develop
    ```
